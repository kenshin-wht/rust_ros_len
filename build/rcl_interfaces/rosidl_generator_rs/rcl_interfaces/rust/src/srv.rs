...
impl Default for GetLoggerLevels_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::srv::rmw::GetLoggerLevels_Request::default())
  }
}

impl rosidl_runtime_rs::Message for GetLoggerLevels_Request {
  type RmwMsg = crate::srv::rmw::GetLoggerLevels_Request;
...
pub struct GetLoggerLevels_Response {
    pub levels: Vec<crate::msg::LoggerLevel>,
}
...
impl Default for GetLoggerLevels_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::srv::rmw::GetLoggerLevels_Response::default())
  }
}

impl rosidl_runtime_rs::Message for GetLoggerLevels_Response {
  type RmwMsg = crate::srv::rmw::GetLoggerLevels_Response;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        levels: msg.levels
          .into_iter()
          .map(|elem| crate::msg::LoggerLevel::into_rmw_message(std::borrow::Cow::Owned(elem)).into_owned())
          .collect(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        levels: msg.levels
          .iter()
          .map(|elem| crate::msg::LoggerLevel::into_rmw_message(std::borrow::Cow::Borrowed(elem)).into_owned())
          .collect(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      levels: msg.levels
          .into_iter()
          .map(crate::msg::LoggerLevel::from_rmw_message)
          .collect(),
    }
  }
}
...
impl Default for SetLoggerLevels_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::srv::rmw::SetLoggerLevels_Request::default())
  }
}

impl rosidl_runtime_rs::Message for SetLoggerLevels_Request {
  type RmwMsg = crate::srv::rmw::SetLoggerLevels_Request;
...
pub struct SetLoggerLevels_Response {
    pub results: Vec<crate::msg::SetLoggerLevelsResult>,
}
...
impl Default for SetLoggerLevels_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::srv::rmw::SetLoggerLevels_Response::default())
  }
}

impl rosidl_runtime_rs::Message for SetLoggerLevels_Response {
  type RmwMsg = crate::srv::rmw::SetLoggerLevels_Response;
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        results: msg.results
          .into_iter()
          .map(|elem| crate::msg::SetLoggerLevelsResult::into_rmw_message(std::borrow::Cow::Owned(elem)).into_owned())
          .collect(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        results: msg.results
          .iter()
          .map(|elem| crate::msg::SetLoggerLevelsResult::into_rmw_message(std::borrow::Cow::Borrowed(elem)).into_owned())
          .collect(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      results: msg.results
          .into_iter()
          .map(crate::msg::SetLoggerLevelsResult::from_rmw_message)
          .collect(),
    }
  }
}
...
impl rosidl_runtime_rs::Service for GetLoggerLevels {
  type Request = crate::srv::GetLoggerLevels_Request;
  type Response = crate::srv::GetLoggerLevels_Response;
...
impl rosidl_runtime_rs::Service for SetLoggerLevels {
  type Request = crate::srv::SetLoggerLevels_Request;
  type Response = crate::srv::SetLoggerLevels_Response;
...
#[derive(Clone, Debug, PartialEq, PartialOrd)]
pub struct GetLoggerLevels_Response {
    pub levels: rosidl_runtime_rs::Sequence<crate::msg::rmw::LoggerLevel>,
}
...
#[derive(Clone, Debug, PartialEq, PartialOrd)]
pub struct SetLoggerLevels_Response {
    pub results: rosidl_runtime_rs::Sequence<crate::msg::rmw::SetLoggerLevelsResult>,
}
...
impl rosidl_runtime_rs::RmwMessage for SetLoggerLevels_Response where Self: Sized {
  ...
  impl rosidl_runtime_rs::Service for GetLoggerLevels {
    type Request = crate::srv::rmw::GetLoggerLevels_Request;
    type Response = crate::srv::rmw::GetLoggerLevels_Response;
  ...
  impl rosidl_runtime_rs::Service for SetLoggerLevels {
    type Request = crate::srv::rmw::SetLoggerLevels_Request;
    type Response = crate::srv::rmw::SetLoggerLevels_Response;
