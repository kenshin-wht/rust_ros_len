  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rclrs_example_msgs__msg__NestedType * ros_message = static_cast<const rclrs_example_msgs__msg__NestedType *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rclrs_example_msgs__msg__NestedType(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rclrs_example_msgs__msg__NestedType * ros_message = static_cast<rclrs_example_msgs__msg__NestedType *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rclrs_example_msgs__msg__NestedType(cdr, ros_message);
}
