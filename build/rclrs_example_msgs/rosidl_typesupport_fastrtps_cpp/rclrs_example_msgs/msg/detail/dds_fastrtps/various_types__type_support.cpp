...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_NestedType(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: float_seq_bounded
  {
    ...
    if (size > 0) {
      cdr.serialize_array(&(ros_message.float_seq_bounded[0]), size);
    }
  }
  ...
  {
    rosidl_typesupport_fastrtps_cpp::cdr_serialize(cdr, ros_message.wstring_member);
  }
  ...
  {
    rosidl_typesupport_fastrtps_cpp::cdr_serialize(cdr, ros_message.bounded_wstring_member);
  }
  ...
  rclrs_example_msgs::msg::VariousTypes & ros_message)
{
  ...
  // Member: float_seq_bounded
  {
    ...
    if (size > 0) {
      cdr.deserialize_array(&(ros_message.float_seq_bounded[0]), size);
    }
  }
  ...
  // Member: wstring_member
  {
    bool succeeded = rosidl_typesupport_fastrtps_cpp::cdr_deserialize(cdr, ros_message.wstring_member);
    if (!succeeded) {
  ...
  // Member: bounded_wstring_member
  {
    bool succeeded = rosidl_typesupport_fastrtps_cpp::cdr_deserialize(cdr, ros_message.bounded_wstring_member);
    if (!succeeded) {
      fprintf(stderr, "failed to deserialize u16string\n");
      return false;
    }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: nested_member
  rclrs_example_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.nested_member,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: nested_member
  current_alignment +=
    rclrs_example_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.nested_member, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: nested_member
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rclrs_example_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_NestedType(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
